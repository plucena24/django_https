...
\begin{minted}{bash}
$ openssl genrsa  openssl genrsa -out example.com.key 4096 # Private key
$ openssl req -new -sha256 -key example.com.key -out example.com.csr # Certificate signing request
